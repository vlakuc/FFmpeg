...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-gpl --disable-doc --disable-indev=shmem --disable-filter=drawqrcode --disable-filter=decodeqrcode --disable-outdev=shmem --disable-optimizations --disable-stripping
prefix=/usr/local
...
CFLAGS=   -std=c11 -pthread  -D_REENTRANT -I/usr/include/SDL2  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign  -fno-math-errno -fno-signed-zeros -ftree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
...
EXTRALIBS=-lXv -lX11 -lXext -Wl,-rpath,/usr/lib64 -lSDL2 -ldl -ldl -Wl,-rpath,/usr/lib64 -lSDL2 -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lasound -Wl,-rpath,/usr/lib64 -lSDL2 -lx264 -lm -llzma -lbz2 -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
...
EXTRALIBS-ffplay=-Wl,-rpath,/usr/lib64 -lSDL2
EXTRALIBS-ffprobe=
EXTRALIBS-ffcopy=
EXTRALIBS-ffserver=
EXTRALIBS-ffmpeg=
...
CONFIG_AUDIO_LEVEL_ENCODER=yes
...
CONFIG_FAKE_LIBX264_ENCODER=yes
CONFIG_FAKE_LIBMP3LAME_ENCODER=yes
CONFIG_FAKE_LIBFAAC_ENCODER=yes
...
!CONFIG_DRAWQRCODE_FILTER=yes
!CONFIG_DECODEQRCODE_FILTER=yes
